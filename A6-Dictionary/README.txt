...
2. Enter the word you want to search (Please enter only lowercase ascii letters!)
...
OTHER CASES:
 - If a word only contains one letter, we treat it still as normal. We try to find it in the dictionary, if not we try to find alternatives.